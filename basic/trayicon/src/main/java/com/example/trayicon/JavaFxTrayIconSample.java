 ...
 * @author: SYH
 * @Create: 2021-10-25 20:31
 **/
public  class JavaFxTrayIconSample extends Application {
    public JavaFxTrayIconSample() {
    }

    public JavaFxTrayIconSample(Stage stage, ScheduledThreadPoolExecutor scheduled) {
        this.stage = stage;
     ...
     * 托盘图标
     * */
    private static final String ICON_IMAGE = "http://5b0988e595225.cdn.sohucs.com/images/20190923/4c398b5aff8f421c8f6ab73e3e9ee14f.jpeg";
    private Stage stage;

    /**
     * 创建线程池，这是正确的方式，不要Timer,不要Executors,具体参数含义可以自行查询
     * */
    ...
    public void start(final Stage stage) {
        ...
        //设置托盘图标（使用aw代码在swing线程上运行），this::addAppToTray是JDK的方法引用
