...
import top.duyunjian.netty.demo.domain.*;
import top.duyunjian.netty.demo.util.CacheUtil;
import top.duyunjian.netty.demo.util.FileUtil;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        switch (fileTransferProtocol.getTransferType()) {
            ...
            case 2 -> {
                ...
                FileBurstInstruct fileBurstInstruct = FileUtil.writeFile("C:\\Users\\Dyj\\Desktop", fileBurstData);
