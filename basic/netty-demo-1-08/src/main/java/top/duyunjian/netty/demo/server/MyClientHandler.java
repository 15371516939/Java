...
public class MyClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        System.out.println("客户端连接到服务端，channelId：" + channel.id());
        System.out.println("连接的服务器IP:" + channel.localAddress().getHostString());
        System.out.println("连接的服务器Port:" + channel.localAddress().getPort());
        //通知服务端连接建立成功
