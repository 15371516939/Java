...
public class Main extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        //        loginController.doLoginSuccess();
                ...
                // 好友 - 对话框
                chat.addTalkBox(-1, 0, "1000001", "李伟立", "https://obohe.com/i/2021/10/24/j9vgd.jpg", "", new Date(), false);
                ...
                chat.addTalkBox(-1, 0, "1000002", "孙周", "https://obohe.com/i/2021/10/24/j9vsa.jpg", "", new Date(), false);
...
//                chat.addTalkMsgUserLeft("1000002", "你所了解的网络往往也是冰山一角", new Date(), true, false, true);
                ...
                chat.addTalkBox(-1, 0, "1000003", "刘一飞", "https://obohe.com/i/2021/10/24/j9vgd.jpg", "", new Date(), false);
...
//                chat.addTalkMsgUserLeft("1000003", "自傲，清高，闷骚，也属于这个群体鲜明标签。", new Date(), true, true, true);
                ...
                chat.addTalkBox(-1, 0, "1000004", "赵源", "https://obohe.com/i/2021/10/24/k9vcl.jpg", "", new Date(), false);
...
//                chat.addTalkMsgUserLeft("1000004", "唯一不变的，是人与人之间的江湖", new Date(), true, false, true);
                ...
                chat.addTalkBox(-1, 0, "1000005", "杜运健", "https://obohe.com/i/2021/10/24/k9w1d.png", "", new Date(), false);
...
//                chat.addTalkMsgUserLeft("1000005", "唯一不变的，是人与人之间的江湖", new Date(), true, false, true);
                ...
                chat.addTalkBox(-1, 0, "1000007", "陶然然", "https://obohe.com/i/2021/10/25/ln23l6.jpg", "", new Date(), false);
                ...
                chat.addTalkBox(-1, 0, "1000006", "梁吴俊", "https://obohe.com/i/2021/10/24/119dyom.jpg", "", new Date(), false);
...
//                chat.addTalkMsgUserLeft("1000006", "唯一不变的，是人与人之间的江湖", new Date(), true, false, true);
                // 群组 - 对话框
                chat.addTalkBox(0, 1, "5307397", "筠竹苑307", "https://obohe.com/i/2021/10/24/118d1i7.jpg", "", new Date(), true);
