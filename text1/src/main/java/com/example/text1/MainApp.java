...
import com.example.text1.config.AppConfig;
import com.example.text1.model.Person;
import com.example.text1.view.BirthdayStatisticsController;
import com.example.text1.view.PersonController;
import com.example.text1.view.PersonEditController;
import com.example.text1.view.RootController;
...
public class MainApp extends Application {
 private final ObservableList<Person>personData = FXCollections.observableArrayList();
    ...
    public MainApp() {
        personData.add(new Person("王林", "软件2126", "男", "江苏南京",
                LocalDate.of(2000, 10, 24), new Image("https://obohe.com/i/2021/10/10/vxuk0p.jpg")));
        personData.add(new Person("彭海洋", "软件2126", "男", "江苏扬州",
                LocalDate.of(1999, 10, 24), new Image("https://obohe.com/i/2021/10/10/vxuna7.jpg")));
        personData.add(new Person("郭佳", "软件2126", "女", "江苏苏州",
                LocalDate.of(2001, 11, 24), new Image("https://obohe.com/i/2021/10/10/vxuns0.jpg")));
        personData.add(new Person("黄志伟", "软件2126", "男", "江苏泰州",
                LocalDate.of(2000, 10, 24), new Image("https://obohe.com/i/2021/10/10/vxukzp.jpg")));
        personData.add(new Person("张珂", "软件2126", "女", "江苏徐州",
                LocalDate.of(2001, 9, 11), new Image("https://obohe.com/i/2021/10/10/vxum5p.jpg")));
        personData.add(new Person("赵丹", "软件2136", "女", "江苏南通",
                LocalDate.of(2000, 10, 24), new Image("https://obohe.com/i/2021/10/10/vxun51.jpg")));
        personData.add(new Person("张建凤", "软件2136", "女", "江苏无锡",
                LocalDate.of(2001, 2, 24), new Image("https://obohe.com/i/2021/10/10/w033vi.jpg")));
        personData.add(new Person("杨阳", "软件1851", "男", "江苏南京",
                LocalDate.of(2000, 10, 23), new Image("https://obohe.com/i/2021/10/10/w0dw10.jpg")));
        personData.add(new Person("尚宇驰", "软件1851", "女", "江苏徐州",
                LocalDate.of(2000, 10, 24), new Image("https://obohe.com/i/2021/10/10/w0txtu.jpg")));
        personData.add(new Person("陈蓉琪", "软件1851", "女", "江苏南京",
                LocalDate.of(2000, 3, 21), new Image("https://obohe.com/i/2021/10/10/w1ypm4.png")));
    }
 ...
 Image(Objects.requireNonNull(MainApp.class.getResourceAsStream(AppConfig.icon))));
