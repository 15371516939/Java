...
import top.duyunjian.chat.domain.user.model.*;
import top.duyunjian.chat.domain.user.repository.IUserRepository;
import top.duyunjian.chat.infrastructure.dao.*;
import top.duyunjian.chat.infrastructure.po.*;

import java.util.ArrayList;
import java.util.List;

import static top.duyunjian.chat.infrastructure.common.Constants.TalkType.Friend;
import static top.duyunjian.chat.infrastructure.common.Constants.TalkType.Group;
